...
un cas particulier de l'énoncé suivent (allpiqué à $X(\dF)$, $K$ et 
aux ${F^*}^n$). 
...
\]
où au second membre figure la trace (\ref{II:4-2}). Pour éviter das 
ambiguités, on écrira parfois cette trace $\tr_\Lambda^H(F,P)$. 
...
et \eqref{II:eq:5-9-2}, amplifées par \ref{II:5-11-1}, fournissent donc 
\[
...
Il reste maintenant à appliquer \ref{II:5-4} (notar que si $\bar V$ est la 
...
que $n=1$. Le cas général en résutera: décomposer $\Lambda$ en ses 
