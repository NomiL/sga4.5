...
Les hypothèses sont celles de la définition \label{VIII:4-1-4}. Supposons 
...
$\sA$ le faisceau d'anneaux et $\underline E$ la catégorie des 
...
d'objets $\sA_{U'}$, où $U$ est un objet de $E$ et $\sA_U$ le faisceau 
...
La catégorie $\cE$ ayant suffisamment d'injectifs, on peut dériver le 
