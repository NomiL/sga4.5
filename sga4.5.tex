...
\section{\texorpdfstring{$\dQ_\ell$}{Ql}-faisceaux}\label{gr95}
...
\section{Réduction à des théorèmes en \texorpdfstring{$\dZ/\ell^n$}{Z/l n}-cohomologie}\label{we48}
...
(\cite[IX.2.10]{sga4}), une somme finie de ceux-ci s'envoie d\'ej\`a sur $B$, 
d\`u le lemme. 
...
\begin{enumerate}[\indent a)]
  ...
  \item Il reste \`a montrer qu'il est possible de remplacer $K$ par un 
    complexe du type voulu \cite[XVII.4.2.10]{sga4}. On remplace d'abord $K$ par 
