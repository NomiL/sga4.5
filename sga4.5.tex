...
\end{equation}
Cette compatibilité est prouvée en (\nameref{V}, \ref{V:3-2-4}). 
...
\eqref{II:eq:7} \eqref{II:eq:4-8} permettent de définir $\tr(f)$ pour $f$ un 
endomorphismede $K\in\ob \mathsf{D}_\text{parf}(\Lambda)$ (et cette trace ne 
...
\begin{enumerate}[\indent a)]
  ...
  \item Pour $X$ propre, il s'agit de remplacer $K$ par un complexe born\'e \`a 
    ...
    $K\otimes_\Lambda\Lambda'\sim K\lotimes_\Lambda\Lambda'$; la f\`eche 
