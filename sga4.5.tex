...
locale et de recollement (\S \hyperref[1-1]{1}, \hyperref[1-2]{2}, 
\hyperref[1-3]{3}), en dégage le concept général de 
topologie de Grothendieck (\S \hyperref[1-6]{6}); pour en justifier 
l'introduction en géométrie algébrique, on démontre un théorème 
de descente fidèlement plat (\S \hyperref[1-4]{4}), généralisation du 
classique théorème de Hilbert (\S \hyperref[1-5]{5}). 
