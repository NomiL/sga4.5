...
La preuve de (\hyperlink{VII:3-A}{A}) est parall\`ele \`a celle de 
...
$K\iso D D K$ (pour $A=\dZ/n$, \hyperref[V]{Dualit\'e} \ref{V:1-4}). 
...
lemme r\'esulte de la commutativit\'e du diagramme (\hyperref[V]{Dualit\'e}, 
\ref{V:1-2}) 
\[\xymatrix{
...
\cite[XVI 2.1]{sga4} et (\hyperref[I]{Cohomologie \'etale} \ref{I:5-1-7}). 
...
\begin{enumerate}[\indent (i)]
  ...
  \item Pour tout fl\`eche de sp\'ecialisation $i:t\to S(s)$ 
    (\hyperref[I]{Cohomologie \'etale}, \ref{I:5-1-2}), si l'on d\'esigne par 
...
(\hyperref[I]{Cohomologie \'etale} \ref{I:5-1-7}). 
