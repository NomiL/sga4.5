...
\begin{enumerate}[\indent a)]
  ...
  \item (composition) Le composé de deux morphismes étale est un morphisme étale.
...
faisceaux $j_! \const{\dZ/n}_U\to \sF$ dont l'image (le lus petit sous-faisceau de 
...
$\eR^q j_*\dZ/n=0$ pour $q\geqslant 0$, et $\eR^q j_*\dZ/n$ est le prolongement 
